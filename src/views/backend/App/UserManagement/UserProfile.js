                        ...
                        <Row>
                            ...
                            <Card className="card-block card-stretch card-height">
                                <Card.Body className="text-center">
                                    ...
                                    <h2 className="mb-2 mt-3 text-primary">42+</h2>
                                    <h4>Awards</h4>
                                </Card.Body>
                            </Card>
                            </Col>
                            ...
                            <Card className="card-block card-stretch card-height">
                                <Card.Body className="text-center">
                                    ...
                                    <h2 className="mb-2 mt-3 text-success">3+ years </h2>
                                    <h4>Experience</h4>
                                </Card.Body>
                            </Card>
                            </Col>
                            ...
                            <Card className="card-block card-stretch card-height">
                                <Card.Body className="text-center">
                                    ...
                                    <h2 className="mb-2 mt-3 text-warning">424+</h2>
                                    <h4>Participated</h4>
                                </Card.Body>
                            </Card>
                            </Col>
                    ...
                    <Col lg="8">
                        <Card className="card-block">
                            ...
                            <Card.Body>
                                ...
                                <h5 className="mb-2">Personal Skills</h5>
                                <ul className="list-unstyled mb-0">
                                    <li className="mb-3"><i className="fa fa-check-circle text-primary fa-lg mr-2"></i>Lorem ipsum dolor sit amet,
                                        consectetur adipiscing elit.</li>
                                    <li className="mb-3"><i className="fa fa-check-circle text-primary fa-lg mr-2"></i>Aliquam ultrices tellus in
                                        auctor blandit.</li>
                                    <li className="mb-3"><i className="fa fa-check-circle text-primary fa-lg mr-2"></i>Etiam tincidunt erat non
                                        ante sagittis bibendum.</li>
                                    <li className="mb-3"><i className="fa fa-check-circle text-primary fa-lg mr-2"></i>Nunc malesuada massa ut
                                        nisl sollicitudin semper.</li>
                                    <li><i className="fa fa-check-circle text-primary fa-lg mr-2"></i>Fusce et arcu in dui feugiat finibus.
                                    </li>
                                </ul>
                                <h5 className="mb-2 mt-4">Professional Skills</h5>
                                <div  className="mm-progress-bar-linear d-inline-block w-100 mb-3">
                                    <span>PHP</span>
                                    <span className="float-right">90%</span>
                                    <ProgressBar  animated now={90} variant="primary" className="mm-progress-bar pro-skill" />
                                </div>
                                <div className="mm-progress-bar-linear d-inline-block w-100 mb-3">
                                    <span>MySQl</span>
                                    <span className="float-right">85%</span>
                                    <ProgressBar  animated now={85} variant="danger" className="mm-progress-bar pro-skill" />
                                </div>
                                <div className="mm-progress-bar-linear d-inline-block w-100 mb-3">
                                    <span>Node Js</span>
                                    <span className="float-right">70%</span>
                                    <ProgressBar  animated now={70} variant="warning" className="mm-progress-bar pro-skill" />
                                </div>
                                <div className="mm-progress-bar-linear d-inline-block w-100">
                                    <span>Angular Js</span>
                                    <span className="float-right">55%</span>
                                    <ProgressBar  animated now={55} variant="info" className="mm-progress-bar pro-skill" />
                                </div>
                            </Card.Body>
                        </Card>
                        <Card className="card-block">
                            <Card.Header>
                                <Card.Header.Title>
                                    <h4 className="card-title">Education Traning</h4>
                                </Card.Header.Title>
                            </Card.Header>
                            <Card.Body>
                                <ul className="list-inline p-0 m-0">
                                    <li className="d-flex align-items-center mb-3">
                                        <div className="profile-icon mm-icon-box rounded-small bg-danger-light svg-danger text-center">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <p className="mb-0">Junior High School | Class of 2008</p>
                                        </div>
                                    </li>
                                    <li className="d-flex align-items-center mb-3">
                                        <div className="profile-icon mm-icon-box rounded-small bg-primary-light svg-primary text-center">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <p className="mb-0">Master of Science in Computer Science | 2015</p>
                                        </div>
                                    </li>
                                    <li className="d-flex align-items-center mb-3">
                                        <div className="profile-icon mm-icon-box rounded-small bg-warning-light svg-warning text-center">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <p className="mb-0">Bachelor of Science in Computer Science | 2013</p>
                                        </div>
                                    </li>
                                    <li className="d-flex align-items-center mb-3">
                                        <div className="profile-icon mm-icon-box rounded-small bg-success-light svg-success text-center">
                                            <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0)">
                                                <path
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <p className="mb-0">Senior High School | 2010</p>
                                        </div>
                                    </li>
                                    <li className="d-flex align-items-center">
                                        <div className="profile-icon mm-icon-box rounded-small bg-info-light svg-info text-center">
                                            <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0)">
                                                <path
                                                    d="M0 8.39995V18.5999C0 18.9314 0.2685 19.1999 0.6 19.1999H3.6V7.19994H1.2C0.537375 7.19994 0 7.73732 0 8.39995ZM13.5 6.59994H12.6V5.09994C12.6 4.93419 12.4658 4.79994 12.3 4.79994H11.7C11.5343 4.79994 11.4 4.93419 11.4 5.09994V7.49994C11.4 7.66569 11.5343 7.79995 11.7 7.79995H13.5C13.6658 7.79995 13.8 7.66569 13.8 7.49994V6.89994C13.8 6.73419 13.6658 6.59994 13.5 6.59994ZM18.6656 4.20144L12.6656 0.201317C12.4685 0.0700041 12.2369 -6.10352e-05 12 -6.10352e-05C11.7631 -6.10352e-05 11.5315 0.0700041 11.3344 0.201317L5.33438 4.20144C5.17003 4.31101 5.03527 4.45945 4.94206 4.63358C4.84884 4.80772 4.80004 5.00218 4.8 5.19969V19.1999H9.6V13.7999C9.6 13.4684 9.8685 13.1999 10.2 13.1999H13.8C14.1315 13.1999 14.4 13.4684 14.4 13.7999V19.1999H19.2V5.20007C19.2 4.79882 18.9994 4.42382 18.6656 4.20144ZM12 9.59995C10.3433 9.59995 9 8.2567 9 6.59994C9 4.94319 10.3433 3.59994 12 3.59994C13.6568 3.59994 15 4.94319 15 6.59994C15 8.2567 13.6568 9.59995 12 9.59995ZM22.8 7.19994H20.4V19.1999H23.4C23.7315 19.1999 24 18.9314 24 18.5999V8.39995C24 7.73732 23.4626 7.19994 22.8 7.19994Z"
