                            ...
                            <Col md="9">
                                <Form className="row g-3 date-icon-set-modal">
                                    ...
                                    <div className="col-md-6 mb-3">
                                        ...
                                        <div className="form-check form-check-inline">
                                            <div className="custom-control custom-radio custom-control-inline">
                                                <Form.Control  type="radio" id="inlineRadio2" name="customRadio-1" className="custom-control-input"/>
                                    ...
                                    <div className="col-md-6 mb-3">
                                        ...
                                        <select defaultValue="" id="inputState" className="form-select form-control choicesjs">
                                    ...
                                    <div className="col-md-12 mb-3">
                                        ...
                                        <Form.Control as="textarea" id="Text9" rows="2" placeholder="Enter Bio"/>
                                    </div>
                                    <div className="col-md-12 mb-3">
                                        ...
                                        <div className="form-check form-check-inline">
                                            <div className="custom-control custom-checkbox custom-control-inline">
                                                <Form.Control  type="checkbox" className="custom-control-input m-0" id="inlineCheckbox2"/>
